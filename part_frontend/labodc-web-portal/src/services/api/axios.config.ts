...
axiosInstance.interceptors.request.use(
  (config: any) => {
    ...
    // If sending FormData, let the browser/axios set the proper multipart boundary.
    // Our axios instance has a default JSON Content-Type, which would otherwise break uploads.
